if TukuiDB.client == "ruRU" then
	...
	tukuilocal.chat_RAID_WARNING_GET = "[Р]"
	tukuilocal.chat_WHISPER_GET = "От"
	tukuilocal.chat_FLAG_AFK = "[АФК]"
	tukuilocal.chat_FLAG_DND = "[ДНД]"
	tukuilocal.chat_FLAG_GM = "[ГМ]"
	tukuilocal.chat_ERR_FRIEND_ONLINE_SS = "|cff298F00входит|r в игру"
	tukuilocal.chat_ERR_FRIEND_OFFLINE_S = "|cffff0000выходит|r из игры"
	...
	tukuilocal.datatext_wg = "Времени до:"
	...
	tukuilocal.core_welcome2 = "Напечатайте |cff00FFFF/uihelp|r для получения доп. информации или зайдите по адресу http://www.tukui.org/v2/forums/topic.php?id=1235"
	...
	tukuilocal.core_raidutil_green = "Зеленая"
	tukuilocal.core_raidutil_purple = "Лиловая"
	tukuilocal.core_raidutil_red = "Красная"
	tukuilocal.core_raidutil_white = "Белая"
	tukuilocal.core_raidutil_clear = "Убрать все"
