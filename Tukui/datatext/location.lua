...
TukuiDB.CreatePanel(location, 60, 25, "TOP", UIParent, "TOP", 0, -8)

local locationtext  = location:CreateFontString(nil, "LOW")
locationtext:SetFont(TukuiCF.media.uffont, TukuiCF.datatext.fontsize, "OUTLINE")
...
----- [[    Coords    ]] -----
	...
	TukuiDB.CreatePanel(xcoords, 35, 25, "RIGHT", location, "LEFT", -3, 0)

	local ycoords = CreateFrame("Frame", "TukuiYCoordsPanel", UIParent)
	TukuiDB.CreatePanel(ycoords, 35, 25, "LEFT", location, "RIGHT", 3, 0)

	local xcoordstext = xcoords:CreateFontString(nil, "OVERLAY")
	xcoordstext:SetFont(TukuiCF.media.uffont, TukuiCF.datatext.fontsize, "OUTLINE")
	xcoordstext:SetPoint("CENTER", xcoords, "CENTER", 1, 0)
	
	local ycoordstext  = ycoords:CreateFontString(nil, "OVERLAY")
	ycoordstext:SetFont(TukuiCF.media.uffont, TukuiCF.datatext.fontsize, "OUTLINE")
